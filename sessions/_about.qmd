...
:link: **Contact:** You can connect with me via [email]({{< var links.mailto >}}), [Twitter]({{< var twitter >}}), [Mastodon]({{< var mastodon >}}),
...
:pray: **Contact:** I am happy for any feedback or suggestions via [email]({{< var links.mailto >}}) or [GitHub issues]({{< var issues >}}). Thank you!
