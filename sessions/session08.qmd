...
You are receiving this email because you took part in the course "{{< var project.title >}}", which took place on {{< var project.when-short >}} at the {{< var project.where-institution >}}.
Thank you very much for your participation!

With this email, we would kindly **ask you for your feedback**.
Your valuable feedback will help us improve future iterations of this course but also other courses on related topics.
...
We will continue the development on the "Version Control Book" available at [{{< var links.book >}}]({{< var links.book >}}).
