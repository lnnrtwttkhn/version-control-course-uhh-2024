### 1. Upload and manage your repository on GitLab or GitHub

#### Connect to MPIB GitLab or GitHub

1. Generate an SSH key and add it to GitHub or GitLab.
1. Use the SSH key to authentication on GitHub or GitLab.

#### "Push" your repository

1. Create an empty *internal* repository on GitLab or *private* repository on GitHub.
1. Set the remote URL for your local `recipes` Git repository.
1. Push your `main` branch to GitLab or GitHub.
...
1. Push the changes on the new branch to GitLab / GitHub.
