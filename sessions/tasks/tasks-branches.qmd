...
1. {{< fa book-open >}} **Reading**: Read the chapter ["{{< meta chapter-title >}}"]({{< meta chapter-title >}}) in the Version Control Book.
1. {{< fa laptop-code >}} **Implementation**: Try out the commands in the chapter.
1. {{< fa laptop-code >}} **Exercises**: Work on the [exercises](#exercises) for the `recipes` project.
